...
public class LombokValueDemoTest {
   ...
   * The class itself is also made final by default, because immutability
   * is not something that can be forced onto a subclass. Like @Data,
   * useful toString(), equals() and hashCode() methods are also generated,
   * each field gets a getter method, and a constructor that covers
   * every argument (except final fields that are initialized in the field
   * declaration) is also generated.
   */
  @Value
